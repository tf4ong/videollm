...
'''
save_name = 'results_30b_dlc_left_paw_blurred.csv'
vid_dir = './vids'
sessions = [os.path.join(vid_dir,i) for i in os.listdir(vid_dir) if i in videos]
for session in sessions:
     if not os.path.exists(os.path.join(session, save_name)):
        ...
        for vid in vids2score:
            ...
            if is_valid:
                #metrics = resample_video_simple(vid,'temp.mp4', 0.5) 
                process_video_with_blur(vid, 'temp.mp4', groups_to_blur=['left_paw'], blur_size=140)
...
save_name = 'results_30b_dlc_snout_blurred.csv'
vid_dir = './vids'
sessions = [os.path.join(vid_dir,i) for i in os.listdir(vid_dir) if i in videos]
for session in sessions:
     if not os.path.exists(os.path.join(session, save_name)):
        ...
        for vid in vids2score:
            ...
            if is_valid:
                #metrics = resample_video_simple(vid,'temp.mp4', 0.5) 
                process_video_with_blur(vid, 'temp.mp4', groups_to_blur=['snout'], blur_size=180)
